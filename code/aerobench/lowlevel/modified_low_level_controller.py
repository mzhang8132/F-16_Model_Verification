'''
Modified Low-level flight controller
'''
...
class modified_LowLevelController(Freezable):
    ...
    def __init__(self, gain_str='old'):
        ...
        # Longitudinal Gains
        K_long = modified_LowLevelController.old_k_long
        K_lat = modified_LowLevelController.old_k_lat
        ...
        self.xequil = modified_LowLevelController.old_xequil
        self.uequil = modified_LowLevelController.old_uequil
