...
from aes_autopilot import AESAutopilot
...
def main():
    ...
    ### TODO do we need this to be roll? Maybe change this depending on initial state?
    ap = AESAutopilot(init_mode='roll', stdout=True, gain_str='old')
