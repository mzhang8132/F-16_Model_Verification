'''
Modified Autopilot State-Machine Logic
...
class modified_Autopilot(Freezable):
    ...
    def __init__(self, init_mode, llc=None):
        ...
        if llc is None:
            # use default
            llc = modified_LowLevelController()
    ...
    def get_checked_u_ref(self, t, x_f16):
        ...
        assert rv.size % 5 == 0, "get_u_ref should return Nz, ps, Ny_r, throttle for each aircraft"

        for i in range(rv.size //5):
            Nz, _ps, _Ny_r, _throttle, _ = rv[5*i:5*(i+1)]
...
class FixedSpeedAutopilot(modified_Autopilot):
    ...
    def __init__(self, setpoint, p_gain):
        ...
        modified_Autopilot.__init__(self, init_mode)
    ...
    def get_u_ref(self, t, x_f16):
        ...
        return 0, 0, 0, self.p_gain * x_dif, 0
